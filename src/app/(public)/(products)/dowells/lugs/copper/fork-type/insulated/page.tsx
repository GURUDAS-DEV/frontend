...
export default function Component() {
  ...
  const packOptions = [
    ...
    { label: "1.5-3.5 / RSI-7926", value: "RSI-7926" },
    { label: "2.5-3.5 / RSI-7928", value: "RSI-7928" },
    { label: "2.5-5 / RSI-7929", value: "RSI-7929" },
    { label: "4.6-3 / RSI-7930", value: "RSI-7930" },
    { label: "4.6-3.5 / RSI-7931", value: "RSI-7931" },
  ];
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const name = `Dowell's Lugs Copper Fork-Type Insulated ${formData.pack}`;
