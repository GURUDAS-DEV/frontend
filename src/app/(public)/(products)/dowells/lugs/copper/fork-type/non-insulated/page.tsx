...
export default function Component() {
  ...
  const productImages = ["/new_pics/Lugs/Copper Lug Fork Type Non Insulated.png","/f_ni.png"];

  const packOptions = [
    { label: "1-3 / RS-7249SPL", value: "RS-7249SPL" },
    { label: "1.5-3.5 / RS-7249", value: "RS-7249" },
    { label: "2.5-3.5 / RS-7251", value: "RS-7251" },
    { label: "2.5-5 / RS-7280", value: "RS-7280" },
    { label: "4.6-3 / RS-7252", value: "RS-7252" },
    { label: "4.6-3.5 / RS-7253", value: "RS-7253" },
  ];
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const name = `Dowell's Lugs Copper Fork-Type Non-Insulated ${formData.pack}`;
 ...
 window.location.reload()
  ...
  <p>
    The fork tongue design allows for easy and fast installation, while providing an easy visual 
    check of wire insertion to ensure proper electrical contact.
  </p>
  ...
  <ul className="list-disc pl-5 space-y-1">
    ...
    <li>Fork tongue design enables quick and easy installation.</li>
