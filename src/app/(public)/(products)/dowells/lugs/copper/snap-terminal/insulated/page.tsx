...
export default function Component() {
  ...
  const packOptions = [
    { label: "1.5 / SND-8352", value: "SND-8352" },
    { label: "2.5 / SND-8348", value: "SND-8348" },
    { label: "4 / SND-8476", value: "SND-8476" },
    { label: "1.5 / SND-8359", value: "SND-8359" },
    { label: "1.5 / SND-8362", value: "SND-8362" },
  ];
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const name = `Dowell's Lugs Copper Snap-Terminal Insulated ${formData.pack}`;
