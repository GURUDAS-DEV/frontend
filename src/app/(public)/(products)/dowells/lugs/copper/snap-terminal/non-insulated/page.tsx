...
export default function Component() {
  ...
  const packOptions = [
    { label: "1.5 / SNP-8351", value: "SNP-8351" },
    { label: "1.5 / SNP-8336", value: "SNP-8336" },
    { label: "1.5 / SNP-8356", value: "SNP-8356" },
    { label: "1.5 / SNP-8358", value: "SNP-8358" },
    { label: "2.5 / SNP-8347", value: "SNP-8347" },
  ];
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const name = `Dowell's Lugs Copper Snap-Terminal Non-Insulated ${formData.pack}`;
