...
export default function Component() {
  ...
  const packOptions = [
    { label: "1.5-3.5 / PSD-7935", value: "PSD-7935" },
    { label: "2.5-3.5 / PSD-7937", value: "PSD-7937" },
    { label: "2.5-5 / PSD-7938", value: "PSD-7938" },
    { label: "4.6-3 / PSD-7939", value: "PSD-7939" },
    { label: "4.6-3.5 / PSD-7940", value: "PSD-7940" },
  ];
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const name = `Dowell's Lugs Copper On-Demand Fork Type Pre-Insulated ${formData.pack}`;
