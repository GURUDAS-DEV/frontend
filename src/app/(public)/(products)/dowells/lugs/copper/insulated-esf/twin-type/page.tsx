...
export default function Component() {
  ...
  const packOptions = [
    { label: "0.5-8 / TW-0.5-8", value: "TW-0.5-8" },
    { label: "0.5-10 / TW-0.5-10", value: "TW-0.5-10" },
    { label: "0.75-8 / TW-0.75-8", value: "TW-0.75-8" },
    { label: "0.75-10 / TW-0.75-10", value: "TW-0.75-10" },
    { label: "1-8 / TW-1-8", value: "TW-1-8" },
    { label: "1-10 / TW-1-10", value: "TW-1-10" },
    { label: "1.5-8 / TW -1.5-8", value: "TW -1.5-8" },
    { label: "1.5-10 / TW -1.5-10", value: "TW -1.5-10" },
    { label: "2.5-8 / TW-2.5-8", value: "TW-2.5-8" },
    { label: "2.5-10 / TW-2.5-10", value: "TW-2.5-10" },
    { label: "4-12 / TW-4-12", value: "TW-4-12" },
    { label: "6-12 / TW-6-12", value: "TW-6-12" },
  ];
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const name = `Dowell's Lugs Copper Insulated-ESF Twin Type ${formData.pack}`;
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 p-6 flex flex-col">
              <div className="space-y-6">
                <div>
                  <h1 className="text-3xl font-bold mb-2">Twin Type</h1>
