...
export default function Component() {
  ...
  const packOptions = [
    ...
    { label: "12-15.15 / 1619", value: "1619" },
    { label: "18-20 / 2119", value: "2119" },
    { label: "18-20 / 2125", value: "2125" },
    { label: "21-25 / 2925", value: "2925" },
    { label: "25.5-29 / 2932", value: "2932" },
    { label: "29-33 / 2938", value: "2938" },
    { label: "33-37 / 3638", value: "3638" },
    { label: "38-42 / 4251", value: "4251" },
    { label: "43-50 / 5451", value: "5451" },
    { label: "48-54 / 5463", value: "5463" },
    { label: "55-60 / 6063", value: "6063" },
    { label: "61-66 / 6675", value: "6675" },
    { label: "67-72 / 7882", value: "7882" },
  ];
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const name = `Dowell's Glands For Single-Compression Heavy Duty ${formData.pack}`;
          ...
          <div className="flex flex-col lg:flex-row">
              ...
              <div className="sticky top-0 bg-background pt-4">
                <div className="relative h-[300px] md:h-[400px] lg:h-[500px] mb-4">
                  ...
                  <div className="absolute -bottom-6 right-4 z-10">
                    <a
                      href="/dowells/gland/single/heavy/pdf.pdf"
                      download
            ...
            <div className="w-full lg:w-1/2 p-6 flex flex-col">
              <div className="space-y-6">
                <div>
                  <h1 className="text-3xl font-bold mb-2">Dowell's Single Compression Heavy Duty</h1>
                  <p className="text-gray-600">Gland</p>
                </div>
