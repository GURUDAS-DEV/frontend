...
export default function Component() {
  ...
  const productImages = ["/dowells/cp/img1.png", "/dowells/cp/img2.png"];
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      const name = `Dowell's Corrosion Inhibiting Compound ${formData.pack}`;
              ...
              <div className="sticky top-0 bg-background pt-4">
                <div className="relative h-[300px] md:h-[400px] lg:h-[500px] mb-4">
                  ...
                  <div className="absolute -bottom-6 right-4 z-10">
                    <a
                      href="/dowells/cp/crimping_paste.pdf"
                      download
            ...
            <div className="w-full lg:w-1/2 p-6 flex flex-col">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="pack">One Size (mm sq.) / CAT. No.</Label>
                    <Select
                      onValueChange={(value) =>
